using MediatR;
using PersonsDirectory.Application.Common.Commands.RemoveRelatedPerson;
...
public sealed class RemoveRelatedPersonHandler(IUnitOfWork uow) : IRequestHandler<RemoveRelatedPersonCommand>
{
